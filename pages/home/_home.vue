<template>
  <div class="container">
    ...
    <div class="main-content">
      <div class="page-main">
        <button class="UpdateAsset" @click="isShowPopup = 'popupCreate'">
          Cập nhật tài sản
        </button>
        <button class="AddAsset" @click="isShowPopup = 'popupCreate','create'">
          Thêm tài sản
        </button>
        ...
        <div class="table-assets">
          ...
          <div class="empty-icn div-center" v-show="!isHaveContent">
            <img src="../../static/icons/file-question.svg" alt="file-rong" />
        ...
        <div class="pagination">
          <div class="pagination-content div-center" v-show="isHaveContent">
            ...
            <span class="pagination-btn div-center">
              ...
              <p v-show="meta.hasPreviousPage" @click="goToPrevPage()">
                {{ meta.currentPage - 1 }}
              </p>
...
export default {
  ...
  methods: {
    ...
    closeTab() {
      document.querySelector(".page-main").classList.add("close-collapse");
      document.querySelector(".page-main").classList.remove("open-collapse");
      document.querySelector(".page-top").classList.add("close-collapse");
      document.querySelector(".page-top").classList.remove("open-collapse");
    },
    openTab() {
      document.querySelector(".page-main").classList.add("open-collapse");
      document.querySelector(".page-main").classList.remove("close-collapse");
      document.querySelector(".page-top").classList.add("open-collapse");
      document.querySelector(".page-top").classList.remove("close-collapse");
    },
    showPopup(type, id) {
